        ...
        <div className="row g-5 mb-5">
          <div className="col-lg-4">
            ...
            <ul className="list-unstyled custom-social">
              <li><span className="fa fa-brands fa-facebook-f"></span></li>
              <li><span className="fa fa-brands fa-twitter"></span></li>
              <li><span className="fa fa-brands fa-instagram"></span></li>
              <li><span className="fa fa-brands fa-linkedin"></span></li>
            </ul>
          </div>
          ...
          <div className="row pt-4">
            <div className="col-lg-6">
              <p className="mb-2 text-center text-lg-start">
                Copyright &copy; {new Date().getFullYear()}. All Rights Reserved. &mdash; Designed with love by <span>Untree.co</span> Distributed By <span>ThemeWagon</span>
              </p>
            </div>
